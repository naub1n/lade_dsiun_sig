...
wget -O sig-os-post-install-3.py https://raw.githubusercontent.com/naub1n/lade_dsiun_sig/$GIT_BRANCH/os/templates/sig-os-post-install-3.py

# Lancement du script
python3 sig-os-post-install-3.py
...
# Préparation QWC2
mkdir -p /app/qwc2/attachments
mkdir -p /app/qwc2/config
mkdir -p /app/qwc2/config-in
mkdir -p /app/qwc2/legends
mkdir -p /app/qwc2/pg_services
mkdir -p /app/qwc2/qgs-resources
mkdir -p /app/qwc2/qwc2
mkdir -p /app/qwc2/solr
